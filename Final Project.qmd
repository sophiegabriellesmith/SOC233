...
Based on our exploratory data and regression analyses, we conclude that there is evidence to reject the null hypothesis, which states no difference in the median starting salary across university types. Specifically, the data indicates that graduates of "Elite" universities possess greater median starting salaries relative to graduates of "Engineering", "Liberal Arts", "Party", and "State" universities. The difference is substantial, with graduates of "Elite" universities earning approximately \$28,000 to \$47,000 more in their first career than graduates of "Engineering", "Liberal Arts", "Party", and "State" universities. Further analyses could control for potential confounding factors; nonetheless, the research answers the question that graduation from an "Elite" university confers with greater post-undergraduate success, at least regarding higher starting salaries.

## 4.2: Limitations 

Undoubtedly, our exploratory data and regression analyses answers the research question by stating that graduation from an "Elite" university confers with greater post-undergraduate success, at least regarding higher starting salaries. Nonetheless, there are some key limitations. Firstly, the data does not control for academic performance, such as GPA or test scores, which likely differs across university type and impacts hiring outcomes. Secondly, students that gain admission to "Elite" universities may possess unobserved characteristics, like discipline and motivation, that separately drive post-undergraduate success. Thirdly, the definitions for university types based on reputation are also rather coarse and could group dissimilar institutions, or even separate a university from its dual reputations. Overall, the introduction of relevant confounding factors for multivariate control would strengthen the ability to make definite causal claims.

## 4.3 Future Directions

Further analyses could build more comprehensive models that account for confounding factors, such academic achievement, socioeconomic status, and intended career field. Access to individual-level data would also allow better control for confounding differences between students across university types. Additionally, longer-term outcome data tracking mid- and late- career trajectories would also provide a comprehensive picture of "Elite" university impacts. Overall, while this initial investigation demonstrates an intriguing pattern, further research could elucidate the advantages of an "Elite" university. Nonetheless, the data prompts critical reflection around hiring practices based solely on university prestige.
